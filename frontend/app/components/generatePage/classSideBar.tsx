                ...
                <div className="w-[90%] space-y-5 flex flex-col">
                    ...
                    {Object.keys(syllabi).map((name, index) =>
                        name == currentClass
                            ? (
                                <button
                                    className="w-full rounded-lg py-2 px-3 hover:cursor-pointer bg-[#292929] text-white"
                                    key={index}
                            ...
                            : (
                                <button
                                    className="text-white w-full rounded-lg py-2 px-3 hover:cursor-pointer hover:bg-[#292929]"
                                    key={index}
                                    onClick={() => selectClass(name)}
                                >
                                    <div className="w-full flex items-center justify-between">
