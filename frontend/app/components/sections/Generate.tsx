...
export default function Generate() {
  ...
  const sortCurrentSyllabus = (first: Function, second: Function, third: Function) => {
                  ...
                  isLoading
                    ? (
                      ...
                      <div role="status">
                        ...
                        <p className="p-4 mt-6 text-slate-300 font-semibold text-center">{loadingInfo}</p>
                      </div>
                    )
                    : (
                ...
                : (
                  <div className="w-full h-full items-center">
                    <div className="m-4 rounded-lg flex items-center justify-center text-center bg-[#1E1E1E] text-white border-slate-300">
                      ...
                      <button onClick={() => {sortCurrentSyllabus(getDifficulty, getProgress, getDate)}} className="title w-1/6">Difficulty</button>
                      <button onClick={() => {sortCurrentSyllabus(getDate, getProgress, getDifficulty)}} className="title w-1/4">Due Date</button>
                      <button onClick={() => {sortCurrentSyllabus(getProgress, getDate, getDifficulty)}} className="title w-1/4">Status</button>
                    </div>
